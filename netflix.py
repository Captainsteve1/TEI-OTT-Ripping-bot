...
if __name__ == "__main__":
   ...
   # PACK
    ...
    print("Uploading To Gdrive Through Rclone " )
    subprocess.run(['rclone','copy', '/usr/src/app/downloads/netflix','TejWebDL:/Rclone'])
    print("Done..🤤\n")
    print("Search File In Here:- https://drive.google.com/drive/folders/1BwfURIWWVHPcFCr8kQr5_0h-ynB_C7Hi")

    print(
        "\nTej WEB-DL Bot took {} Sec".format(
