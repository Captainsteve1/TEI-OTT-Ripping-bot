...
class SunNXT(object):
    ...
    "https://": "https://SU2TuiBYWmMoNiNYPWuv2YXT:s799YY2jGXzHSWmWLJJQ5bye@in125.nordvpn.com:89",
        }
    ...
    def download(self):
        ...
        print('\nMuxing....') 
        subprocess.run([self.mkvmergeexe,'--output',PATH + '/' + output +'.mkv', '--language', '0:eng',"--track-name","0:Trooporiginals", '--default-track', '0:yes', '--compression', '0:none', PATH +'/' + 'decrypted.mp4', '--language', '0:eng',"--track-name","1:Trooporiginals", '--default-track', '0:yes', '--compression' ,'0:none', PATH +'/' + 'decrypted.m4a','--language', '0:eng',"--track-name","0:Trooporiginals", '--default-track', '0:yes', '--compression', '0:none'])
        print("\nAll Done .....") 
        ...
        subprocess.run(['rclone','copy', '/usr/src/app/output','Rose:/sunnxt'])
        print(" search here:- https://drive.google.com/drive/folders/1NuxAT8qhFk7GvQCiDnpEqctQShkBKjDx?usp=sharing") 
    '''def rclone(self):
